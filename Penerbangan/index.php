...
function totalPajak($pajakAsal, $pajakTujuan)
{
	...
	foreach ($pajakAsalPenerbangan as $pajak1 => $pajak1_value) {
		//Mengambil biaya pajak dari bandara asal yang dipilih
		if ($pajakAsal == $pajak1) {
	...
	foreach ($pajakTujuanPenerbangan as $pajak2 => $pajak2_value) {
		//Mengambil biaya pajak dari bandara tujuan yang dipilih
...
<body>
	...
	if (isset($_POST['submit'])) {
		...
		//Menampung inputan User kedalam Array sementara
